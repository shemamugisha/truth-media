...
const ProfileHeader: FC = () => {
  ...
  const currentAccount = "0x9684f2Ef5Dc45EF6DF9A5df2704CC96D72e23E2b";
    ...
    <div className={style.wrapper}>
      <div className={style.header}>
        ...
        <div className={style.details}>
          <div className={style.primary}>Shema Mugisha</div>
      ...
      <div className={style.coverPhotoContainer}>
        <img
          src="https://forums.crackberry.com/attachments/blackberry-q10-f272/171886d1371181552t-bbm-display-picture-limitations-423341110329_qy737vid_l.jpg"
          alt="cover"
